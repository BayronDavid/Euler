import { calculateHeunApproach } from "../../calculus/Heun/index.js"
import { calculateExactSolution } from "../../calculus/Exact/index.js"
import { calculateError } from "../../calculus/Heun/error.js"
...
rangeOfH.oninput = function (event) {
    ...
    calculateHeunApproach(parseFloat(x0.value), parseFloat(xf.value), parseFloat(y0.value), h);
    calculateError()

...
// Solucion exacta 
const whitePoints = new THREE.Points(geometryWhitePoints, materialWhitePoints);
const lineBlue = new THREE.Line(geometryBlueLine, materialBlueLine);

// Aproximacion Euler
const lineBlack = new THREE.Line(geometryBlackLine, materialBlackLine);
const pointsEuler = new THREE.Points(geometryEulerPoints, materialRedPoints);
